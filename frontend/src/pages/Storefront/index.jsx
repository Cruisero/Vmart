...
import { StorefrontContext, useStorefront, useStorefrontPath } from '../../store/storefrontStore'
                ...
                <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#F3F4F6' }}>
                    ...
                    <main className="fresh-main-content" style={{ flex: 1 }}>
                        <Routes>
                            ...
                            <Route path="forgot-password" element={<FreshForgotPassword />} />
                            <Route path="reset-password" element={<FreshResetPassword />} />
                ...
                {shop.shopNotice && <AgentNoticeBanner text={shop.shopNotice} />}
                    <main style={{ flex: 1 }}>
                        <Routes>
                            ...
                            <Route path="forgot-password" element={<ZenForgotPassword />} />
                            <Route path="reset-password" element={<ZenResetPassword />} />
                            <Route path="terms" element={<TermsPage />} />
                            <Route path="refund-policy" element={<RefundPolicyPage />} />
                        </Routes>
                    </main>
...
function StorefrontFooter() {
    ...
    return (
        <footer className="sf-footer-new">
