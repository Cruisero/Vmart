...
export default function FreshForgotPassword() {
    const L = useBuyerL()
            ...
            <div className="fa-page">
                <div className="fa-card" style={{ textAlign: 'center' }}>
                    <div className="fa-header">
                        ...
                        <h1 className="fa-title">{L('邮件已发送', 'Email Sent')}</h1>
                        <p className="fa-sub" style={{ marginTop: 8 }}>
                    ...
                    <Link to={`${prefix}/login`} className="fa-guest">{L('auth.goLogin', '返回登录')}</Link>
                </div>
            </div>
        )
    }
        ...
        <div className="fa-page">
            <div className="fa-card">
                <div className="fa-header">
                    ...
                    <h1 className="fa-title">{L('忘记密码', 'Forgot Password')}</h1>
                    <p className="fa-sub">{L('输入您的注册邮箱，我们将发送重置链接', 'Enter your email to receive a password reset link')}</p>
                </div>
                ...
                <form className="fa-form" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="fa-submit" disabled={loading}>
                        {loading ? <span className="fa-spinner" /> : L('发送重置链接', 'Send Reset Link')}
                    </button>
                </form>
