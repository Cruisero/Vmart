...
const statusConfig = {
    ...
    cancelled: { label: '已取消',  icon: FiAlertCircle,  bg: '#FFF5F2', iconBg: '#FEE2E2', iconColor: '#C45D3E', border: '#FECACA' },
    refunded:  { label: '已退款',  icon: FiRefreshCw,    bg: '#F5F3FF', iconBg: '#EDE9FE', iconColor: '#A04030', border: '#DDD6FE' },
}
